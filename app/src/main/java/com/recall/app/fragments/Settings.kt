...
import com.recall.app.MenuDialog
...
import com.recall.app.databinding.PreferenceBinding
import com.recall.app.databinding.PreferenceSeekbarBinding
import com.recall.app.miscellaneous.Operations
import com.recall.app.preferences.*
import com.recall.app.viewmodels.BaseNoteModel
...
class Settings : Fragment() {
    ...
    private fun setupBinding(binding: FragmentSettingsBinding) {
        ...
        binding.GitHub.setOnClickListener {
            openLink("https://github.com/srajanbuilds/RECALL_APP")
        }
        ...
        binding.Rate.setOnClickListener {
            openLink("https://srajanbuilds.github.io/RECALL_APP/")
        }
        ...
        val geminiKey = model.preferences.geminiApiKey
        binding.GeminiApiKey.Title.text = "Gemini API Key"
        binding.GeminiApiKey.Value.text = if (geminiKey.isEmpty()) "Tap to set" else "••••••••"
        binding.GeminiApiKey.root.setOnClickListener {
            val input = EditText(requireContext()).apply {
                setText(model.preferences.geminiApiKey)
            ...
            MaterialAlertDialogBuilder(requireContext())
                ...
                .setPositiveButton("Save") { _, _ ->
                    ...
                    model.preferences.geminiApiKey = key
                    binding.GeminiApiKey.Value.text = if (key.isEmpty()) "Tap to set" else "••••••••"
                }
    ...
    private fun exportBackup() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Recall Backup")
    ...
    private fun sendEmailWithLog() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("mail2srajanmishra@gmail.com"))
        intent.putExtra(Intent.EXTRA_SUBJECT, "Recall [Feedback]")
