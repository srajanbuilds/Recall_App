...
import com.recall.app.activities.ConfigureWidget
import com.recall.app.activities.MakeList
import com.recall.app.activities.TakeNote
...
class WidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            ACTION_CHECKED_CHANGED -> {
                ...
                val database = RecallDatabase.getDatabase(context.applicationContext as Application)
    ...
    companion object {
        ...
        private const val EXTRA_MODIFIED_NOTES = "com.recall.app.EXTRA_MODIFIED_NOTES"
        private const val ACTION_NOTES_MODIFIED = "com.recall.app.ACTION_NOTE_MODIFIED"

        const val ACTION_OPEN_NOTE = "com.recall.app.ACTION_OPEN_NOTE"
        const val ACTION_OPEN_LIST = "com.recall.app.ACTION_OPEN_LIST"

        const val ACTION_CHECKED_CHANGED = "com.recall.app.ACTION_CHECKED_CHANGED"
        const val EXTRA_POSITION = "com.recall.app.EXTRA_POSITION"
    }
}
