...
import com.recall.app.databinding.ActivityViewImageBinding
...
import com.recall.app.recyclerview.adapter.ImageAdapter
...
class ViewImage : AppCompatActivity() {
    ...
    private fun saveToDevice(image: Image) {
        ...
        if (file != null && file.exists()) {
            ...
            intent.putExtra(Intent.EXTRA_TITLE, "Recall Image")
