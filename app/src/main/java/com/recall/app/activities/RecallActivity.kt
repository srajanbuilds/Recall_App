...
import com.recall.app.databinding.ActivityRecallBinding
import com.recall.app.databinding.DialogProgressBinding
import com.recall.app.databinding.DialogReminderBinding
...
import com.recall.app.recyclerview.adapter.AudioAdapter
import com.recall.app.recyclerview.adapter.ErrorAdapter
import com.recall.app.recyclerview.adapter.PreviewImageAdapter
import com.recall.app.room.Audio
import com.recall.app.room.Folder
import com.recall.app.room.Frequency
import com.recall.app.room.Image
import com.recall.app.room.Reminder
import com.recall.app.room.Type
import com.recall.app.viewmodels.RecallModel
import com.recall.app.widget.WidgetProvider
import kotlinx.coroutines.launch
import java.text.DateFormat
import java.util.Calendar

abstract class RecallActivity(private val type: Type) : AppCompatActivity() {

    internal lateinit var binding: ActivityRecallBinding
    internal val model: RecallModel by viewModels()
        ...
        if (checkSelfPermission(permission) != PackageManager.PERMISSION_GRANTED) {
            if (shouldShowRequestPermissionRationale(permission)) {
                MaterialAlertDialogBuilder(this)
                    .setMessage(R.string.please_grant_recall_audio)
    ...
    private fun checkAlarmPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            ...
            if (manager.canScheduleExactAlarms()) {
                ...
                MaterialAlertDialogBuilder(this)
                    .setMessage(R.string.please_grant_recall_alarm)
                    .setNegativeButton(R.string.cancel, null)
                    .setPositiveButton(R.string.continue_) { _, _ ->
    ...
    private fun checkNotificationPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            if (checkSelfPermission(permission) != PackageManager.PERMISSION_GRANTED) {
                if (shouldShowRequestPermissionRationale(permission)) {
                    MaterialAlertDialogBuilder(this)
                        .setMessage(R.string.please_grant_recall_notification)
                        .setNegativeButton(R.string.cancel, null)
                        .setPositiveButton(R.string.continue_) { _, _ ->
    ...
    private fun setupToolbar() {
        ...
        val pin = menu.add(R.string.pin, R.drawable.pin) { item -> 
