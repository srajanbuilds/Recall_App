...
import com.recall.app.databinding.ActivityConfigureWidgetBinding
import com.recall.app.miscellaneous.IO
import com.recall.app.preferences.Preferences
import com.recall.app.preferences.View
...
class ConfigureWidget : AppCompatActivity(), ItemListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val database = RecallDatabase.getDatabase(application)
