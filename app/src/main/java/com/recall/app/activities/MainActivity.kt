...
import com.recall.app.databinding.ActivityMainBinding
import com.recall.app.databinding.DialogColorBinding
...
import com.recall.app.recyclerview.adapter.ColorAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleIntent(intent: Intent?) {
        if (intent != null && intent.getBooleanExtra("open_settings", false)) {
            navigateWithAnimation(R.id.Settings)
        }
    }
