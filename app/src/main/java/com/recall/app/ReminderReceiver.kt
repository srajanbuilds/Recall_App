...
import com.recall.app.room.IdReminder
    ...
    companion object {
        ...
        private fun sendNotification(context: Context, baseNote: BaseNote) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                val channelId = "com.recall.app.reminders"
             ...
             * Very unlikely that the user will have created more than 2^31 notes during their use of Recall.
