...
import com.recall.app.ActionMode
import com.recall.app.AttachmentDeleteService
import com.recall.app.Cache
import com.recall.app.Progress
import com.recall.app.R
import com.recall.app.ReminderReceiver
import com.recall.app.legacy.Migrations
import com.recall.app.legacy.XMLUtils
import com.recall.app.miscellaneous.Export
import com.recall.app.miscellaneous.IO
import com.recall.app.miscellaneous.Operations
import com.recall.app.miscellaneous.applySpans
import com.recall.app.preferences.AutoBackup
import com.recall.app.preferences.ListInfo
import com.recall.app.preferences.Preferences
import com.recall.app.preferences.SeekbarInfo
import com.recall.app.room.Attachment
import com.recall.app.room.Audio
import com.recall.app.room.BaseNote
import com.recall.app.room.Color
import com.recall.app.room.Converters
import com.recall.app.room.Folder
import com.recall.app.room.Header
import com.recall.app.room.Image
import com.recall.app.room.Item
import com.recall.app.room.Label
import com.recall.app.room.RecallDatabase
import com.recall.app.room.Reminder
import com.recall.app.room.Type
import com.recall.app.room.livedata.Content
import com.recall.app.room.livedata.SearchResult
import com.recall.app.widget.WidgetProvider
    ...
    private fun importZipBackup(uri: Uri) {
        ...
        viewModelScope.launch(exceptionHandler) {
            ...
            withContext(Dispatchers.IO) {
                ...
                val databaseEntry = zipFile.getEntry(RecallDatabase.DatabaseName)

                val databaseFile = File(backupDir, RecallDatabase.DatabaseName)
