...
import com.recall.app.image.Event
...
import com.recall.app.preferences.BetterLiveData
...
import com.recall.app.room.SpanRepresentation
...
class RecallModel(private val app: Application) : AndroidViewModel(app) {
    ...
    fun setReminder(reminder: Reminder) {
        viewModelScope.launch {
            ...
            this@RecallModel.reminder.value = reminder
            updateReminder()
        }
    }
