...
import com.recall.app.activities.RecordAudio
import com.recall.app.audio.Status.PAUSED
import com.recall.app.audio.Status.READY
import com.recall.app.audio.Status.RECORDING
...
class AudioRecordService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "com.recall.app.audio"
